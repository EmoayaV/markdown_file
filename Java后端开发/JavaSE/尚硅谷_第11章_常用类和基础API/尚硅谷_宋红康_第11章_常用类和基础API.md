...
- 记住String是一个类，有个属性value，属性的数据类型是char型的数组，或者Byte型的数组。
...
![image-20230511154253401](D:\markdown file\截图\image-20230511154253401.png)

![image-20230511164723048](D:\markdown file\截图\image-20230511164723048.png)

![image-20230511164950956](D:\markdown file\截图\image-20230511164950956.png)

- 只要是new出来的string，就会创建两个对象，一个在字符串常量池中，一个在堆空间中，
- 通过new创建的字符串，其变量存的是堆空间中的地址，通过字面量方式创建的字符串，其变量存的是字符串常量池中的地址
- 为什么又常量池，是为了不用重复创建对象
...
- **可变不可变指的是能不能修改内部的value变量，或者是value变量指向的数组。**
...
![image-20230515162230317](D:\markdown file\截图\image-20230515162230317.png)

![image-20230515162533671](D:\markdown file\截图\image-20230515162533671.png)

![image-20230515162703317](D:\markdown file\截图\image-20230515162703317.png)
...
![image-20230515165355530](D:\markdown file\截图\image-20230515165355530.png)

![image-20230515165140899](D:\markdown file\截图\image-20230515165140899.png)

![image-20230515165608673](D:\markdown file\截图\image-20230515165608673.png)

![image-20230515170214521](D:\markdown file\截图\image-20230515170214521.png)
...
- **java.math包的BigInteger**可以表示`不可变的任意精度的整数`。BigInteger 提供所有 Java 的基本整数操作符的对应物，并提供 java.lang.Math 的所有相关方法。另外，BigInteger 还提供以下运算：模算术、GCD 计算、质数测试、素数生成、位操作以及一些其他操作。 
