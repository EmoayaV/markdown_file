...
![image-20230526113242464](D:\markdown file\截图\image-20230526113242464.png)

#### 内存中4个字节相当于1个slot，相当于一个槽，属于最基本的单位。int、byte、shot、char、float类型的数据和引用数据类型的数据都是用1个槽来装，long、double类型用2个槽来装。
